...
module datapath_or_tb;
  ...
  reg IncPC, Read;
  reg OR, AND, ADD, SUB, MUL, DIV, SHR, SHRA, SHL, ROR, ROL, NEG, NOT;
  reg R2in, R5in, R6in;
  reg Clock;
  reg [31:0] Mdatain;
  ...
  datapath DUT(
    ...
    .HIout(1'b0), .LOout(1'b0), .InPortout(1'b0), .Cout(1'b0), .HIin(1'b0), .LOin(1'b0),
  ...
  always @(Present_state) begin
    ...
    IncPC=0; Read=0;
    OR=0; AND=0; ADD=0; SUB=0; MUL=0; DIV=0; SHR=0; SHRA=0; SHL=0; ROR=0; ROL=0; NEG=0; NOT=0;
    R2in=0; R5in=0; R6in=0;
    Mdatain=32'h0;

    case (Present_state)
      Reg_load1a: begin
        Mdatain=32'h00000034; Read=1; MDRin=1; #15 Read=0; MDRin=0;
      end
      Reg_load1b: begin
        MDRout=1; R5in=1; #15 MDRout=0; R5in=0;
      end
      Reg_load2a: begin
        Mdatain=32'h00000045; Read=1; MDRin=1; #15 Read=0; MDRin=0;
      end
      Reg_load2b: begin
        MDRout=1; R6in=1; #15 MDRout=0; R6in=0;
      end

      T0: begin PCout=1; MARin=1; IncPC=1; Zin=1; #15 PCout=0; MARin=0; IncPC=0; Zin=0; end
      T1: begin
        Zlowout=1; PCin=1; Read=1; MDRin=1;
        Mdatain=32'hXXXX0000; // <-- REPLACE with your OR opcode for "or R2, R5, R6"
        #15 Zlowout=0; PCin=0; Read=0; MDRin=0;
      end
      T2: begin MDRout=1; IRin=1; #15 MDRout=0; IRin=0; end
      T3: begin R5out=1; Yin=1; #15 R5out=0; Yin=0; end
      T4: begin R6out=1; OR=1; Zin=1; #15 R6out=0; OR=0; Zin=0; end
      T5: begin Zlowout=1; R2in=1; #15 Zlowout=0; R2in=0; end
    endcase
  end
