...
module datapath_tb;
    ...
    always @(Present_state) begin
        case (Present_state)               
            ...
            Reg_load1a: begin   
                // Load R5 with a value to invert
            ...
            T1: begin
                ...
                // Opcode for “not R2, R5” (placeholder — replace with correct pattern)
                Mdatain <= 32'h00000000;
            end
